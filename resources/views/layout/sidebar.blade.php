        ...
        <ul>
            <li class="nav-item nav-item-has-children">
                <a href="#0" data-bs-toggle="collapse" data-bs-target="#ddmenu_1" aria-controls="ddmenu_1"
                    ...
                    <span class="text" href="{{ route('home') }}">Home</span>
                </a>
                <ul id="ddmenu_1" class="collapse show dropdown-nav">
                    <li>
                        <a href="{{ route('cards') }}" class="active"> Card </a>
                    </li>
                    <li>
                        <a href="{{ route('card_sets') }}" class="active"> Card Sets </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="ddmenu_3" class="collapse dropdown-nav">
                    ...
                    <li>
                        <a href="{{ route('register.step1') }}"> Sign Up </a>
                    </li>
                </ul>
            </li>
            <span class="divider">
